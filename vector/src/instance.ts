...
class Instance extends Plugin.Instance(Config, globalThis.ISDKWorldInstanceBase) {
  ...
  @Action({
    ...
    description: 'Manually sets the angle of the Vector by their components. This is automatically called when doing any Vector operation.',
    category: 'angle'
  })
  ...
  setComponents(
    @Param({ desc: 'The X component' })
    x: number = 0,
    @Param({ desc: 'The Y component' })
    y: number = 0
  ): void {
    this.x = x;
    this.y = y;
  ...
  @Action({
    listName: 'Max',
    description: 'Sets the vector components to the maximum of the vector and the input values (x, y).',
    category: 'calculation'
  })
  max(
    @Param({ desc: 'The X component' })
  ...
  @Action({
    listName: 'Min',
    description: 'Sets the vector components to the minimum of the vector and the input values (x, y).',
    category: 'calculation'
  })
  min(
    @Param({ desc: 'The X component' })
  ...
  @Action({
    listName: 'Clamp',
    description: 'Clamps the vector components between the given min and max values',
    category: 'calculation'
  })
  clamp(
    @Param({ desc: 'The minimum X component' })
    minX: number,
    @Param({ desc: 'The minimum Y component' })
    minY: number,
    @Param({ desc: 'The maximum X component' })
    maxX: number,
    @Param({ desc: 'The maximum Y component' })
    maxY: number
  ): void {
  ...
  @Expression({
    description: 'Returns the Euclidean distance from the vector to another point.',
    category: 'calculation'
  })
  dist(
    @Param({ desc: 'The X component' })
  ...
  @Expression({
    description: 'Returns the squared Euclidean distance from the vector to another point.',
    category: 'calculation'
  })
  sdist(
    @Param({ desc: 'The X component' })
  ...
  @Action({
    listName: 'Reject',
    description: 'Rejects the vector onto a perpendicular direction from another vector (x, y).',
    category: 'calculation'
  })
  reject(
    @Param({ desc: 'The X component' })
  ...
  @Expression({
    description: 'Returns the dot product of the vector and another vector (x, y).',
    category: 'calculation'
  })
  dot(
    @Param({ desc: 'The X component' })
  ...
  @Expression({
    description: 'Returns the cross product of the vector and another vector (x, y).',
    category: 'calculation'
  })
  cross(
    @Param({ desc: 'The X component' })
  ...
  @Action({
    description: 'Sets each component to 1.0 if it\'s positive, -1.0 if it\'s negative and 0.0 if it\'s zero.',
    category: 'conversion'
  })
  sign() {
  ...
  @Action({
    listName: 'Snap',
    description: 'Snaps each component to the nearest multiple of the corresponding step',
    category: 'calculation'
  })
  snapped(
    @Param({ desc: 'The step X component' })
    stepX: number = 1,
    @Param({ desc: 'The step Y component' })
    stepY: number = 1
  ) {
  ...
  @Condition({
    description: 'Checks if the vector is normalized, i.e. its length is approximately equal to 1.'
  })
